...
![GitHub Release](https://img.shields.io/github/v/cover-jet-plugin/actions/workflows/build.yaml/badge.svg?branch=main)](https://github.com/gw-kit/delta-coverage-plugin/actions/workflows/base-ci.yml)
